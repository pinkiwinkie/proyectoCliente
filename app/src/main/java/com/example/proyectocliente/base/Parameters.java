...
//    public static String URL_IMAGE = "http://192.168.1.22/dashboard/images/images/";
    ...
    public static String URL = "http://"+ GestionPreferencias.getInstance().getIP(context)+":"+
            GestionPreferencias.getInstance().getPort(context)+"/"+
            GestionPreferencias.getInstance().getSchema(context) +"/";
    public static String URL_IMAGE = "http://"+GestionPreferencias.getInstance().getIP(context)
            +GestionPreferencias.getInstance().getPath(context);
}
